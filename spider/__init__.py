...
def initialLogger():
  ...
  handler1 = logging.FileHandler(os.path.join(settings.BASE_DIR,"logs/spider." + str(datetime.date.today()) + ".log"),"a",encoding="utf8")
  ...
  logger_spider.setLevel(logging.DEBUG)
  logger_spider.addHandler(handler1)
  logger_spider.addHandler(handler2)
